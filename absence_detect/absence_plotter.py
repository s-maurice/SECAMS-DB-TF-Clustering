...
def main():
    ...
    for userid in df['USERID'].unique():
        ...
        cur_absence_df['Day'] = in_days
        cur_absence_df['Present'] = in_days.isin(user_df['DOY'])
        cur_absence_df['Weekday'] = cur_absence_df['Day'].apply(lambda x: x.weekday() < 5)
